  ...
  <q-layout view="hHh lpR fFf">
    <q-page-container>
        <q-page class="flex flex-center text-center">
          <div style="width: 100%;">
            <q-icon name="person" style="font-size: 15rem;"/>
          </div>
          <div class="q-gutter-sm flex flex-row text-center">
            <q-card rounded class="bg-primary">
                <q-icon name="inbox" style="font-size: 4rem;"/><br>
                <q-btn no-caps rounded push @click="$router.push('/Homepage')" class="q-mr-sm" label="Job Order Requests" color="secondary"/>
            </q-card>
            <q-card rounded class="bg-primary text-center">
                <q-icon name="drafts" style="font-size: 4rem;"/><br>
                <q-btn no-caps rounded push @click="$router.push('/Homepage')" class="q-mr-sm" label="Employees / Staff" color="secondary"/>
            </q-card>
            <q-card rounded class="bg-primary text-center">
